...
for station in stations:
    ...
    best_nse = -100; model_name='GRU/'+str(station)+'_256_GRU.h5' ## Save the best nse and best model. 
    ...
    for training_id in range(15):
        ensemble_name = 'GRU/'+str(station)+'_256_GRU_'+str(training_id)+'.h5'
        model = build_model()
...
np.save('GRU_NSE_256', d_nse);
np.save('GRU_MSE_256', d_mse);
np.save('GRU_high_mse_256', high_mse)
np.save('GRU_low_mse_256', low_mse)
print('done')
