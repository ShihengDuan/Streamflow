...
for station in stations:
    ...
    best_nse = -100; model_name='LSTM/'+str(station)+'_370_LSTM.h5' ## Save the best nse and best model. 
    ...
    for training_id in range(15):
        ensemble_name = 'LSTM/'+str(station)+'_370_LSTM_'+str(training_id)+'.h5'
...
np.save('LSTM_NSE_370', d_nse);
np.save('LSTM_MSE_370', d_mse);
np.save('LSTM_high_mse_370', high_mse)
np.save('LSTM_low_mse_370', low_mse)
print('done')
