...
for station in stations:
    ...
    best_nse = 0; model_name='DCNN/'+str(station)+'_365_ps_DCNN.h5' ## Save the best nse and best model. 
...
np.save('DCNN/d_dcnn_365_ps_nse', d_nse)
np.save('DCNN/d_dcnn_365_ps_r', d_r)
np.save('DCNN/d_dcnn_365_ps_mae', d_mae)
np.save('DCNN/d_dcnn_365_ps_mse', d_mse)
