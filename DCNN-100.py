...
for station in stations:
    ...
    best_nse = -100; model_name='windowsize/'+str(station)+'_1000_DCNN.h5' ## Save the best nse and best model. 
    for training_id in range(15):
        ensemble_name='windowsize/'+str(station)+'_100_'+str(training_id)+'.h5'
...
np.save('windowsize/d_100_dcnn_nse', d_nse)
np.save('windowsize/d_100_dcnn_r', d_r)
np.save('windowsize/d_100_dcnn_mae', d_mae)
np.save('windowsize/d_100_dcnn_mse', d_mse)
